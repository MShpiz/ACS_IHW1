...
.text 
	...
	jal	print_array		# В качестве аргументов принимает количество элементов в массиве, адрес массива.
					# Возвращает - ничего.
...
.global enter_array
enter_array:		# получает от пользователя количество элементов в массив и 
